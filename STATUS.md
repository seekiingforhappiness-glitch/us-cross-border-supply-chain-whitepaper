...
- 阶段：**v0.4 执行中（费用/账单对账闭环，F1-F5 已批准）。X1 建模对齐完成 → X2 数据与迁移**
- v0.4 plan：docs/cost-plan-v0.4.md；核心命题：费用异常复用风险闭环，边际成本 ≤1/4
- v0.2 + v0.3 已收官（断言 24/24 + 22/22），回归保护由 XA3/XE2 断言承担
