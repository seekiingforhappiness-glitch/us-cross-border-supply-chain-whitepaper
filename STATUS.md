...
- **v0.5 作品集打磨已完成**（Fable 亲自执行，写作非开发）：architecture.md（Mermaid 架构图×3）、
  demo-script.md（十分钟演示台本+备答）、one-pager.md、article.md（约 4000 字案例文章，
  含 XE3 诚实失败的完整叙事）；README 增作品集导航。
- 后续候选：单证号级 ER、风险评分模型（ground truth 已备）。新场景须先立 plan 经人批准。
